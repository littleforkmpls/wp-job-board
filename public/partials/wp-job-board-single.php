  ...
  <div class="wpjb-form__modal-overlay">
    <div class="wpjb-form">
      ...
      <div class="wpjb-form__bd">
        <form action="">
          <div class="wpjb-form__group">
            <label for="wpjb-form__group--name">Name</label>
            <input type="text" id="wpjb-form__group--name" />
          </div>
          <div class="wpjb-form__group">
            <label for="wpjb-form__group--email">Email</label>
            <input type="email" id="wpjb-form__group--email" />
          </div>
          <div class="wpjb-form__group">
            <label for="wpjb-form__group--phone">Phone</label>
            <input type="tel" id="wpjb-form__group--phone" />
          </div>
          <div class="wpjb-form__group">
            <label for="wpjb-form__group--resume">Resume</label>
            <input type="file" id="wpjb-form__group--resume" />
          </div>
          <div>
